...
ActiveRecord::Schema.define(version: 2020_10_16_084223) do
  ...
  create_table "managemants", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["item_id"], name: "index_managemants_on_item_id"
  ...
  create_table "orders", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.bigint "managemant_id"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["managemant_id"], name: "index_orders_on_managemant_id"
  end
  ...
  add_foreign_key "managemants", "items"
